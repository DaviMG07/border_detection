...
module soc_system_mm_interconnect_0 (
	...
	wire  [128:0] pio_data_in_s1_agent_rp_data;                                                       // pio_data_in_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] pio_data_out_s1_agent_rp_data;                                                      // pio_data_out_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_data_in_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_data_in_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_data_in_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] pio_data_in_s1_burst_adapter_source0_channel;                                       // pio_data_in_s1_burst_adapter:source0_channel -> pio_data_in_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_data_out_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pio_data_out_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_data_out_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] pio_data_out_s1_burst_adapter_source0_channel;                                      // pio_data_out_s1_burst_adapter:source0_channel -> pio_data_out_s1_agent:cp_channel
